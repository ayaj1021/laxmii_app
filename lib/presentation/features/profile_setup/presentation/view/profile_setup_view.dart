...
class _ProfileSetupViewState extends ConsumerState<ProfileSetupView> {
  ...
  // Check if current page can proceed to next
    ...
    switch (_currentPage) {
      case 0:
        ...
        return _nameController.text.isNotEmpty &&
            ...
            _selectedIncomeType != null;
      case 1:
        // Financial goals page - check if at least one goal is selected
        final checkboxState = ref.read(checkboxStateProvider);
        return checkboxState.values.any((value) => value == true);
      case 2:
        // AI preferences page - you can add validation here if needed
        return true;
      default:
        return false;
    }
  ...
  // Handle page change validation
  bool _handlePageChange(int page) {
    if (page > _currentPage) {
      // Moving forward - check if current page is valid
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        // Watch for changes in checkbox state for validation
