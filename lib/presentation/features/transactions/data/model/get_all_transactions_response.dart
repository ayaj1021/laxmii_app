...
GetAllTransactionsResponse getAllTransactionsResponseFromJson(String str) =>
    GetAllTransactionsResponse.fromJson(json.decode(str));

String getAllTransactionsResponseToJson(GetAllTransactionsResponse data) =>
