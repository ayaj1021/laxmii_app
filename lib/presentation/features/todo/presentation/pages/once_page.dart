...
class OncePage extends ConsumerStatefulWidget {
  const OncePage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _WeeklyPageState();
}

class _WeeklyPageState extends ConsumerState<OncePage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    final tasksList =
        tasks.data?.tasks?.where((task) => task.priority == 'once').toList();
    return Padding(
